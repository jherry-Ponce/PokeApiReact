  ...
  return (
    <div className='bg-dark bg-gradient text-white'>
        ...
        <Grid container   spacing={2} className="tex_footer">
            ...
            <Grid item xs={12}>
               <p>Esta aplicacion web de pokedex se realizo con la finalidad de practicar y seguir aprendiendo sobre React y el consumo de Apis(PokeApi). Si te agrada regalame una estrella en <Link href="https://github.com/jherry-Ponce/PokeApiReact" className='text-white' underline="hover" target="_blank" ><b> GitHub</b></Link></p> 
            </Grid>
            <Grid item xs={12}>
             <h4> Tools</h4>
            </Grid>
